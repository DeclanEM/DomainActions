...
function CreateMenuItems() {
    ...
    browser.contextMenus.create({
        ...
        icons: {
            "16": "Resources/Icons/Icon_NewWindow.svg"
        },
    ...
    browser.contextMenus.create({
        ...
        icons: {
            "16": "Resources/Icons/Icon_Refresh.svg"
        },
        parentId: "DomainActionsMenuItem",
        contexts: ["tab"],
    ...
    browser.contextMenus.create({
        ...
        icons: {
            "16": "Resources/Icons/Icon_Close.svg"
        },
        parentId: "DomainActionsMenuItem",
        contexts: ["tab"],
...
function InstalledHandler(details) {
    if (details.reason === "update") {
        browser.notifications.create(
            "UpdateNotification", {
                "iconUrl": browser.runtime.getURL("Resources/Icons/Icon_96.png"),
...
function NotificationClickHandler(id, index) {
    ...
    if (id === "UpdateNotification") {
        browser.tabs.create({ url: browser.runtime.getURL("Pages/Changelog/Changelog.html") });
    } else if (id === "InstallNotification") {
        browser.tabs.create({ url: browser.runtime.getURL("Pages/Onboard/Onboard.html") });
    }
}
